...
export default function ProtectedRoute({ children }) {
  ...
  if (user.role === 'user') {
    return (
      <div className="flex h-screen flex-col items-center justify-center gap-3 text-center text-slate-600">
        ...
        <button onClick={logout} className="rounded-lg bg-stone-800 px-4 py-2 text-sm font-semibold text-white hover:bg-stone-900">ออกจากระบบ</button>
      </div>
    );
  }
  return children;
